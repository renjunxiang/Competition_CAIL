...
class Predictor:
    def __init__(self, num_words=20000, maxlen=400,
                 accusation_path=localpath + '/model/accusation/Bidirectional_GRU_GlobalMaxPool1D_epochs_2.h5',
                 relevant_articles_path=localpath + '/model/relevant_articles/Bidirectional_GRU_GlobalMaxPool1D_epochs_2.h5',
                 tokenizer_path=localpath + '/model/tokenizer_fact_20000.pkl'):
    ...
    def predict(self, content):
        ...
        for i in range(0, len(content)):
            result.append({
                ...
                "imprisonment": transform(relevant_articles[i]),
                "articles": [None]
            })
        return result
